...
type GroupReplaceRequest struct {
...
func (o GroupReplaceRequest) MarshalJSON() ([]byte, error) {
...
type NullableGroupReplaceRequest struct {
	value *GroupReplaceRequest
	isSet bool
}

func (v NullableGroupReplaceRequest) Get() *GroupReplaceRequest {
	return v.value
}

func (v *NullableGroupReplaceRequest) Set(val *GroupReplaceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupReplaceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupReplaceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupReplaceRequest(val *GroupReplaceRequest) *NullableGroupReplaceRequest {
	return &NullableGroupReplaceRequest{value: val, isSet: true}
}

func (v NullableGroupReplaceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupReplaceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
